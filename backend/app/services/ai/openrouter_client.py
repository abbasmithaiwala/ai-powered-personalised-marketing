...
from app.services.ai.base_types import Message
...
class OpenRouterClient:
    """
    Production-ready OpenRouter API client with retry logic.
    ...
    async def complete(
        ...
        Raises:
            OpenRouterAPIKeyError: If API key is missing
        ...
        for attempt in range(self.max_retries):
            try:
                ...
                if response.status_code >= 500:
                    ...
                    await asyncio.sleep(wait_time)
                    last_exception = OpenRouterServerError(
        ...
        raise OpenRouterError("Failed to complete request after all retries")
